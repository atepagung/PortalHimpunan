                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="npm" type="text" class="form-control" name="npm" value="{{ old('npm') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('JK') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="JK" type="text" class="form-control" name="JK" value="{{ old('JK') }}" required autofocus>
